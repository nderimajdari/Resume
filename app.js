...
function applyThumbnailState(tmpl) {
  ...
  state.experience = [
    { title: 'Senior Designer', company: 'Studio North', location: 'Paris', start: '2022', end: 'Present', description: 'Led product design systems and improved user workflows across web and mobile platforms.' },
    { title: 'Designer', company: 'Blue Labs', location: 'Lyon', start: '2019', end: '2022', description: 'Created brand, UX and visual design assets for SaaS and editorial teams.' }
  ];
  state.education = [
    { school: 'Design Academy', degree: 'BA Visual Design', location: 'Paris', start: '2015', end: '2019', description: '' }
  ];
  state.skills = [
